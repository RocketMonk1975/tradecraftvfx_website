        ...
        <div class="faq-items">
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>Project timelines vary depending on scope and complexity. A simple website might take 4-6 weeks, while a complex web application could take 3-6 months. We'll provide a detailed timeline during our proposal phase.</p>
            </div>
          </div>
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>We typically require a 50% deposit to begin work, with the remaining 50% due upon completion. For larger projects, we can arrange milestone-based payments.</p>
            </div>
          </div>
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>Yes, we offer various maintenance packages to keep your website secure, updated, and performing well. These can be added to any service package.</p>
            </div>
          </div>
